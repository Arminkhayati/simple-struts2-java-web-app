    ...
    <div class="col-md-12" style="height:70px ">
        ...
        <div class="col-md-12 talgh" style="margin-right: 150px;padding-top: 40px">
            <div class="col-md-3" style="height: 400px;width: 500px;background-color: black;margin-right:250px">
                ...
                <s:form action="FarmerProfile/FarmerLogin" cssStyle="padding-top: 40px;padding-right: 40px;">
                ...
                <a href="<s:url action="FarmerRegister/Registeration"/> "style="color: white"> <button  style="background-color: #4caf50;width: 80px;height: 60px; margin-right: 20px;color: white;font-size: 20px">ثبت نام </button></a>
            ...
            <%--<form style="padding-top: 40px;padding-right: 40px;font-size: 20px"> نام کار بری<input type="text" name="1" style="margin-right: 20px"></form> <br><br>--%>
                ...
                <%--<div dir="ltr" style="padding-top: 25px;padding-left: 25px;">--%>
                    <%--<a href="<s:url action="FarmerRegister/Registeration"/> "style="color: white"> <button  style="background-color: #4caf50;width: 70px;height: 40px; margin-right: 20px;color: white;font-size: 20px">ثبت نام </button></a>--%>
                    <%--<a href="<s:url action="FarmerProfile/FarmerLogin"/>"style="color: white"> <button style="background-color: #4caf50;width: 70px;height: 40px;color: white;font-size: 20px"> ورود</button></a>--%>
                <%--</div>--%>
