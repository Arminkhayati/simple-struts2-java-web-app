        ...
        <div class="col-md-12 talgh" style="margin-right: 150px;padding-top: 40px">
            <div class="col-md-3" style="height: 90%;width: 40%;background-color: black;padding-top: 40px;margin-right: 280px">
                ...
                <s:form action="Register" cssStyle="padding-top: 30px;padding-right: 30px;">
                    ...
                    <s:textfield name="sex" label="جنسیت"  cssStyle="margin-right: 20px;margin-right: 20px;"/>
                    ...
                    <s:textfield name="nationalId" label="کد ملی"  cssStyle="margin-right: 20px;margin-right: 20px;"/>
                    <s:textfield name="zip" label="کد پستی"  cssStyle="margin-right: 20px;margin-right: 20px;"/>
                    <tr>
                        <td colspan="2">
                ...
                <%--<form style="padding-top: 30px;padding-right: 30px;font-size: 20px;">  نام خانوادگی <input type="text" name="1" style="margin-right: 20px;;margin-right: 20px"></form>--%>
                <%--<form style="padding-top: 30px;padding-right: 30px;font-size: 20px;float: right">سن<input type="text" name="1" style=""></form>--%>
               <%--<form style="padding-top: 30px;padding-right: 30px;font-size: 20px">جنسیت<input type="text" name="1" style="margin-right: 20px"></form>--%>
                ...
                <%--<form style="padding-top: 30px;padding-right: 30px;font-size: 20px"> کد پستی<input type="text" name="1" style="margin-right: 20px"></form>--%>
                <%--<form style="padding-top: 30px;padding-right: 30px;font-size: 20px;float: right">تلفن<input type="text" name="1" style="margin-right: 20px"></form>--%>
                <%--<form style="padding-top: 30px;padding-right: 30px;font-size: 20px">نام کاربری<input type="text" name="1" style="margin-right: 20px"></form>--%>
